...
export const initialData: SeedData = {
  users: [
    {
      email: "sauvageBolivia23@gmail.com",
      name: "Sauvage Bolivia",
      password: bcryptjs.hashSync("SauvageBolivia23@"),
      role: "admin",
    }
  ],
  ...
  products: [
    ...
    {
      description:
        "Introducing the Tesla Chill Collection. The Chill Pullover Hoodie has a premium, heavyweight exterior and soft fleece interior for comfort in any season. The sex_shop hoodie features subtle thermoplastic polyurethane Tesla logos across the chest and on the sleeve, a double layer single seam hood and pockets with custom matte zipper pulls. Made from 60% cotton and 40% recycled polyester.",
    ...
    {
      description:
        "The Unisex 3D Large Wordmark Pullover Hoodie features soft fleece and an adjustable, jersey-lined hood for comfort and coverage. Designed in a sex_shop style, the pullover hoodie includes a tone-on-tone 3D silicone-printed wordmark across the chest.",
